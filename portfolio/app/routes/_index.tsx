...
export default function Index() {
  return (
    <div className="flex flex-col gap-3 items-center mx-auto w-[calc(100%-40px)] p-6 lg:p-12 lg:flex-row lg:justify-center lg:flex-wrap lg:gap-6">
      ...
      <div className="bg-[#a28089] text-[#000] rounded p-3 w-full transform hover:-translate-y-[5%] hover:shadow-lg transition duration-500 ease-in-out border border-[#000000] border-opacity-20 lg:basis-[38%] lg:grow">
      ...
      <div className="bg-[#a28089] text-[#000] rounded p-3 w-full transform hover:-translate-y-[5%] hover:shadow-lg transition duration-500 ease-in-out border border-[#000000] border-opacity-20 lg:basis-[58%] lg:grow">
        {/* legend for color meaning */}
        <div className="grid grid-cols-[repeat(2,7em)] md:grid-cols-[repeat(4,7em)]">
        ...
        <div className="py-2 px-1 rounded border border-yellow-300">

        </div>
      </div>

      <div className="bg-[#a28089] text-[#000] rounded p-3 w-full transform hover:-translate-y-[5%] hover:shadow-lg transition duration-500 ease-in-out border border-[#000000] border-opacity-20 lg:basis-[48%] lg:grow">
        skills go here
      </div>
