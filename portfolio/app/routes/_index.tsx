  ...
  return (
    <div className="flex flex-col gap-4 lg:gap-8 items-center mx-auto max-w-[1200px] w-[calc(100%-40px)] p-6 lg:p-12 lg:flex-row lg:justify-center lg:flex-wrap">
      ...
      <div className="bg-[#a28089] text-[#1E1E1E] rounded p-4 lg:p-6 w-full shadow-md transform hover:-translate-y-[5%] hover:shadow-lg transition duration-500 ease-in-out border border-[#000000] border-opacity-20 lg:basis-[100%] lg:grow">
        ...
        <hr className="my-4 border-t-2 border-[#1E1E1E] opacity-50" />
        <p className="text-sm font-bold md:text-2xl">Like what you see? Let's work together! <span className="text-sm font-bold md:text-2xl"><i className="fa-solid fa-arrow-right"></i></span> </p>
      </div>
    </div>
  );
}
